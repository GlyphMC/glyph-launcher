...
<div class="fixed top-0 flex h-screen max-h-full w-80 flex-col gap-y-4 bg-zinc-900 p-6">
	<div class="flex items-center justify-between text-zinc-100">
		...
		<a href="/settings">
			<Settings class="h-6 w-6 text-zinc-100 hover:text-zinc-50" />
		</a>
	</div>

	<div class="flex w-full gap-4">
		<input class="font-bold w-full rounded-md bg-zinc-300 px-4 py-1.5 placeholder:text-zinc-200" type="text" placeholder="Search instances..." />
	</div>
